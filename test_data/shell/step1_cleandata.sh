cd /datapool/test_data/01.cleandata/sample1
/datapool/software/anaconda3/envs/RNAseq/bin/fastp  -i /datapool/ngs/sample1/sample1.R1.fastq.gz -o sample1_R1.clean.fq.gz  -I /datapool/ngs/sample1/sample1.R2.fastq.gz -O sample1_R2.clean.fq.gz -j sample1.json -h sample1.html
...
/datapool/software/anaconda3/envs/qiime2/bin/fastqc --extract sample1.unmap.1.fq.gz -o /datapool/test_data/01.cleandata/nohostqc_result
/datapool/software/anaconda3/envs/qiime2/bin/fastqc --extract sample1.unmap.2.fq.gz -o /datapool/test_data/01.cleandata/nohostqc_result
...
cd /datapool/test_data/01.cleandata/sample2
/datapool/software/anaconda3/envs/RNAseq/bin/fastp  -i /datapool/ngs/sample2/sample2.R1.fastq.gz -o sample2_R1.clean.fq.gz  -I /datapool/ngs/sample2/sample2.R2.fastq.gz -O sample2_R2.clean.fq.gz -j sample2.json -h sample2.html
...
/datapool/software/anaconda3/envs/qiime2/bin/fastqc --extract sample2.unmap.1.fq.gz -o /datapool/test_data/01.cleandata/nohostqc_result
/datapool/software/anaconda3/envs/qiime2/bin/fastqc --extract sample2.unmap.2.fq.gz -o /datapool/test_data/01.cleandata/nohostqc_result
